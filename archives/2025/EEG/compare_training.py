#!/usr/bin/env python3
"""
Compare multiple training configurations on the same EEG dataset (.npz or directory).
...
Note: 
    Make sure to run simplify_labels.py first to create the simplified datasets in comparisons/<mode>/ before running this script.

Usage:
  python compare_training.py --data EEG_clean/processed/simplified/hand --fs 300 --base_outdir comparisons/hand
"""
